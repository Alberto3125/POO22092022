 ...
 */
package reutilzacioncodigo2209;
 ...
 * @author pablo
 */
public class ReutilzacionCodigo2209 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        miCompu.getCpu().setMarca(" AND ");
        System.out.println( miCompu );
        // Ejercicio.-Establecer un mose marca logitech tipo optico
        ...
        Computadora compu2 = new Computadora("Apple", "MacBook Pro",
                ...
                new Procesador("Apple", 3.4f));
        System.out.println( compu2 );
        // mouse apple y tipo touch
        // una forma de hacerlo compu2.setRaton( new Mouse ("apple", "Touch"));
        ...
        Alumno alu2 = new Alumno(" 319110164 ", " ICO ", "Jose Perez", "19");
        System.out.println( alu2 );
        
        alu1.setNumeroCuenta("319110165");
        alu1.setEdad("19");
        System.out.println( alu1 );
